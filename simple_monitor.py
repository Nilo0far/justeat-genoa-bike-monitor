...
def get_genoa_vehicle_options():
    ...
    # ----------------------------------
    # Find Vehicle Selection question
    # ----------------------------------
...
print("======================================")
print("Just Eat Genoa Bike Monitor started")
...
while True:
    ...
    try:
        ...
        print()
        print(
            f"[{now}] Checking Just Eat..."
        )

        options = (
            get_genoa_vehicle_options()
        )
